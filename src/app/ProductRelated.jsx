...
export default function ProductRelated({ currentProductName }) {
  const hoodieProducts = file.filter(product => product.class === 'hoodie' && product.name !== currentProductName);

  return (
    <div>
      <div className='md:px-28 px-4 relative top-8'>
        {/* TitleRelated component */}
      </div>
